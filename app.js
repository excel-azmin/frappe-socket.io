...
// Configuration
const BASE_URL = process.env.SOCKET_URL || 'https://arcpos.example.me';
const SITE_NAME = process.env.SITE_NAME || 'arcpos.example.me';
const BEARER_TOKEN = process.env.BEARER_TOKEN || 'Your Token';
const USER_EMAIL = process.env.USER_EMAIL || 'azmin@example.me';
